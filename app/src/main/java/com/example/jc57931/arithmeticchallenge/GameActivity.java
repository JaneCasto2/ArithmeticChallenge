...
public class GameActivity extends AppCompatActivity {
    ...
    private void setViewObjects(){
        ...
        mScoreText = findViewById(R.id.MyScore);
        mHighScoreText = findViewById(R.id.HighScore);
        mChoice[0] = findViewById(R.id.Option1);
        mChoice[1] = findViewById(R.id.Option2);
        mChoice[2] = findViewById(R.id.Option3);
        mMenu = findViewById(R.id.BackToMenu);
